...
<div id="pagetree_form_con"   class="client-val-form">
<?php if ($_POST['create_root']=='true' && $model->isNewRecord) : ?>              
    <h3 id="create_header">Create New Root Categorydemo </h3>
<?php elseif ($model->isNewRecord) : ?>     
    <h3 id="create_header">Create New Categorydemo </h3>
<?php  elseif (!$model->isNewRecord):  ?>     
    <h3 id="update_header">Update Categorydemo <?php  echo $model->name;  ?> (ID:<?php   echo $model->id;  ?>) </h3>
<?php   endif;  ?>
    
<div   id="success-pagetree" class="notification success png_bg" style="display:none;">
    <a href="#" class="close">
        <img src="<?php echo Yii::app()->request->baseUrl.'/css/images/icons/cross_grey_small.png';  ?>"title="Close this notification" alt="close" />
    </a>
</div>

<div  id="error-pagetree" class="notification errorshow png_bg" style="display:none;">
    <a href="#" class="close">
        <img src="<?php echo Yii::app()->request->baseUrl.'/css/images/icons/cross_grey_small.png';  ?>"title="Close this notification" alt="close" />
    </a>
</div>
...
<?php   $formId='pagetree-form';
$ajaxUrl=($model->isNewRecord)?( ($_POST['create_root']!='true')?CController::createUrl(''):CController::createUrl('pagetree/createRoot')):CController::createUrl('pagetree/update');
...
$success='function(data){
    ...
    if (response.success ==true)
    {
        ...
        $("#pagetree-form").slideToggle(1500);'.
        $updatesuccess.
    '}
         else {
                   $("#error-pagetree")
